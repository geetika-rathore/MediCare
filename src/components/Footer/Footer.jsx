...
import { AiFillYoutube, AiFillLinkedin, AiFillGithub, AiOutlineInstagram } from "react-icons/ai"
...
const Footer = () => {
    ...
    const socialLinks = [
        ...
        {
            path: "https://github.com/geetika-rathore",
            icon: <AiFillGithub className="group-hover:text-white w-4 h-5 " />
        }, {
            path: "https://www.instagram.com",
            icon: <AiOutlineInstagram className="group-hover:text-white w-4 h-5 " />
        }, {
            path: "https://www.linkedin.com/in/geetika-rathore-13131223b/",
                ...
                <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]  ">
                    <div>
                        ...
                        <p className="text-[16px] font-[400] leading-7 text-textColor mt-4 " >
                            Copyright ©️{year} developed by Geetika Rathore all right reserved.
                        </p>
